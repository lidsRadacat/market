...
public class FileUploadController extends BaseController{
	...
	public RestApi<String> upload(@RequestParam("uid") int uid,
	     ...
	     try {
	         ...
	         String fileName = uploadFileService.saveFile(uploadFile,file,realpath);
	         return new RestApi<>(StatusCode._20000.getCode(),"/upload/"+fileName,StatusCode._20000.getMessage());
