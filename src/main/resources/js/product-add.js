...
//				image_url += (product_id[i]+"_");				
//			}else{
//				image_url += product_id[i];
//			}
//		}
		...
		$.ajax({
			...
			data: JSON.stringify({
				...
				width: $("#product_widht").val(),
				height: $("#product_height").val(),
				price: $("#product_price").val(),
				marketPrice: $("#product_market_price").val(),
				costPrice: $("#product_cost_price").val(),
				uom: $("#product_uom").val(),
				...
				attribute: $("#product_attribute").val(),
				supplier: $("#product_supplier").val(),
				keyword: $("#product_keyword").val(),
				placeOrigin: $("#product_place_origin").val(),
